...
public class TenderResult extends AppCompatActivity {
    Context context;
    ...
    private void getBhartiList(String srcString) {
        try {
            ...
            Call<List<TenderModel>> call = RetrofitClient.getInstance().getMyApi().getTendersResult(mobile, userid, deviceid,srcString);
