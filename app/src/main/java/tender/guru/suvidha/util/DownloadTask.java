...
/*
                apkStorage = new File(Environment.getExternalStorageDirectory().getPath()+"/tg/");
 Log.i("FIlepath",apkStorage.getAbsolutePath());
...
*/
                ...
                FileOutputStream fos = new FileOutputStream(Environment.getExternalStorageDirectory().getPath() + "/" + downloadFileName);//Get OutputStream for NewFile Location
