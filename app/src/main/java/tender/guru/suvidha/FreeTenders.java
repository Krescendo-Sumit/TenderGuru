...
public class FreeTenders extends AppCompatActivity {
    Context context;
    ...
    private void getBhartiList(String srcString) {
        try {
            ...
            Call<List<TenderModel>> call = RetrofitClient.getInstance().getMyApi().getTenders_Offline(mobile, userid, deviceid,srcString);
